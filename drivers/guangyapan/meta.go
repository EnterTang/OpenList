...
type Addition struct {
	RootPath       string `json:"root_path" help:"GuangYaPan full path used as mount root"`
	...
	SendCode       bool   `json:"send_code" type:"bool" help:"Set true and save to send SMS code; auto-resets to false after sending"`
	VerifyCode     string `json:"verify_code" type:"text" help:"SMS verification code; fill then save to finish login"`
