...
type Addition struct {
	...
	DeleteSourceAfterETF                         bool   `json:"delete_source_after_etf" type:"bool" default:"true" label:"生成后删除源文件" group:"ETF" collapsed:"true" help:"生成 .etf 后默认删除源媒体文件并清理回收站。"`
	ClusterDedicatedAccount                      bool   `json:"cluster_dedicated_account" type:"bool" default:"true" label:"集群专用账号" group:"ETF" collapsed:"true" help:"允许集群任务在 ETF 结果持久化后清理临时转存目录中的媒体文件并清空回收站；临时转存目录及回收站不要混放个人文件。"`
